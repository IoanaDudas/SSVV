...
public class NotaXMLRepository extends AbstractXMLRepository<Pair<String, String>, Nota> {
    ...
    public void createFile(Nota notaObj) {
        ...
        StudentFileRepository srepo = new StudentFileRepository(sval, "src/main/resources/studenti.txt");
        TemaFileRepository trepo = new TemaFileRepository(tval, "src/main/resources/teme.txt");
